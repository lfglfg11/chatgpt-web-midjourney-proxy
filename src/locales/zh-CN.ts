export default {
  ...
  chat: {
    ...
    placeholder: '文本/图片/视频生成都可使用此chat模式，可贴截图或拖拽文件（Shift + Enter = 换行，"/" 触发提示词）',
  ...
  ,mjchat:{
    ...
    ,tStyles:'艺术程度'
    ,tVersion:'模型版本'
    ,dalleInfo:' 说明：   <li>1 提供支持openAi的POST /v1/images/generations接口的画图模型</li>  <li>2 服务器的图片有时效性，请做好备份</li>   <li>3 jimeng-3.0/jimeng-3.1/nano-banana模型为1k分辨，jimeng4系列/nano-banana-pro为2k分辨率、有后缀-4k的模型为4k分辨率</li> <li>4 注意：除jimeng-3.0/3.1模型外所有模型均支持多图参考！</li> '
    ,version:'版本'
    ,size:'尺寸'
  ...
  mj:{
    ...
    ,infoStar:'此项目基于 <a  class="text-blue-600 dark:text-blue-500" href="https://api.xbyjs.top" target="_blank"> GitHub </a>，免费且基于 MIT 协议，没有任何形式的付费行为！ </p><p> <a  class="text-blue-600 dark:text-blue-500" href="https://github.com/Dooy/chatgpt-web-midjourney-proxy" target="_blank"> 小北API </a>解锁AI的潜力，体验强大的API平台（当前主打多模态生成量大管饱）'
    ,setBtSaveChat:'仅保存会话'
    ,setBtSaveSys: '保存至系统'
