export default {
  ...
  ,mjchat:{
    ...
    ,tStyles:'艺术程度'
    ,tVersion:'模型版本'
    ,dalleInfo:' 说明：   <li>1 提供支持openAi的POST /v1/images/generations接口的画图模型</li>  <li>2 服务器的图片有时效性，请做好备份</li>   <li>3 jimeng-3.0/jimeng-3.1/nano-banana模型为1k分辨，jimeng4系列/nano-banana-pro为2k分辨率、有后缀-4k的模型为4k分辨率</li> <li>4 注意：所有模型均支持多图参考！</li> '
    ,version:'版本'
    ,size:'尺寸'
